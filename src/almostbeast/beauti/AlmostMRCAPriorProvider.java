...
public class AlmostMRCAPriorProvider implements PriorProvider {
	
	@Override
	public List<Distribution> createDistribution(BeautiDoc doc) {
        doc.beautiConfig.suppressBEASTObjects.add("almostbeast.math.distributions.AlmostMRCAPrior.tree");
        doc.beautiConfig.suppressBEASTObjects.add("almostbeast.math.distributions.AlmostMRCAPrior.monophyletic");
        doc.beautiConfig.suppressBEASTObjects.add("almostbeast.math.distributions.AlmostMRCAPrior.taxonset");

        AlmostMRCAPrior prior = new AlmostMRCAPrior();
        try {
            ...
            Set<Taxon> candidates = getTaxonCandidates(prior, doc);
    ...
    static protected Set<Taxon> getTaxonCandidates(AlmostMRCAPrior prior, BeautiDoc doc) {
